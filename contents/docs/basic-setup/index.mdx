...
<CardGrid>
  <Card
    ...
    title="Installation"
    description="Follow the quick start guide to install AUTOUI and get up and running."
  ...
  <Card
    subtitle="Library"
    title="@autoai-ui/autoui on npm"
    description="Install the @autoai-ui/autoui package and start embedding ModalChat."
