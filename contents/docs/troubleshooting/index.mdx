...
<Step>
<StepItem title="Verify Plugin Configuration">
...
<StepItem title="Check TypeScript Config">
Verify you have a `tsconfig.json` or `tsconfig.app.json` file in your project root.
</StepItem>

<StepItem title="Register Components and Functions">
Use the registration utilities to register your components and functions:
...
<StepItem title="Check Console for Errors">
Review the build console output for plugin error messages that may indicate what's wrong.
</StepItem>
</Step>
...
- Review configuration: [Quick Start](/docs/quickstart)
