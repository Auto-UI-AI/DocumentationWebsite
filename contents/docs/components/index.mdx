...
The Components Registry allows you to register React components that the AI assistant can render dynamically. This enables **generative UI**—the assistant can compose new interfaces on the fly based on user requests.
