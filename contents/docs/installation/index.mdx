...
- **`sharedSecret`**: A secret key for authenticating requests to the LLM proxy
...
- Get your `appId` and `sharedSecret` from [autoui-chi.vercel.app](https://autoui-chi.vercel.app/)
- Use `https://autoui-proxy.onrender.com` as your `proxyUrl` (default hosted proxy)
...
**For Next.js:**
```bash
NEXT_PUBLIC_AUTOUI_APP_ID=app_1768313360453_dbptv83
NEXT_PUBLIC_AUTOUI_PROXY_URL=https://autoui-proxy.onrender.com
NEXT_PUBLIC_AUTOUI_SHARED_SECRET=your-shared-secret-from-service
```

**For Create React App:**
```bash
REACT_APP_AUTOUI_APP_ID=app_1768313360453_dbptv83
REACT_APP_AUTOUI_PROXY_URL=https://autoui-proxy.onrender.com
REACT_APP_AUTOUI_SHARED_SECRET=your-shared-secret-from-service
```
...
export const autouiConfig: AutoUIConfig = {
  appId: process.env.NEXT_PUBLIC_AUTOUI_APP_ID || 'your-app-id',
  llm: {
    proxyUrl: process.env.NEXT_PUBLIC_AUTOUI_PROXY_URL || 'https://autoui-proxy.onrender.com',
