...
The AUTOUI proxy server is a **required backend component** that keeps your OpenRouter API key secure on the server while allowing your frontend to communicate with LLM providers.
